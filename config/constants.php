...
return [
    ...
    'ENUM' => [
        ...
        ,
        'TOURNAMENTS' =>
        ['TYPE' => ['league' => 'Group Tournament', 'knockout' => 'Knock-Out', 'multistage' => 'Groups + Knock-Out'],
		...
		[
			'MATCH_TYPE' => [
                'CRICKET' => ['odi' => 'ODI', 't20' => 'T20', 'test' => 'TEST'],
                'TENNIS' => ['singles' => 'SINGLES', 'doubles' => 'DOUBLES', 'mixed' => 'MIXED'],
                'TABLE TENNIS' => ['singles' => 'SINGLES', 'doubles' => 'DOUBLES', 'mixed' => 'MIXED'],
		...
		'TEAMS'=>
		[
		     'TEAM_LEVEL'=>[  'ANY'=>'ANY','U12' => 'U12','U14' => 'U14','U16' => 'U16',  'U19' => 'U19', 'U21' => 'U21']
		],
		'ORGANIZATION'=>
		[
		     'ORGANIZATION_TYPE'=>[  'academy' => 'ACADEMY', 'college' => 'COLLEGE', 'school' => 'SCHOOL','corporate'=>'CORPORATE', 'other' => 'OTHER']
		],
		'SCORE_CARD' => 
		[
			'OUT_AS' => [ 'bowled' => 'Bowled', 'caught' => 'Caught', 'handled_ball' => 'Handled the ball', 'hit_ball_twice' => 'Hit the ball twice', 'hit_wicket' => 'Hit wicket', 'lbw' => 'LBW', 'obstructing_the_field' => 'Obstructing the field' ,'retired' => 'Retired', 'run_out' => 'Run out', 'stumped' => 'Stumped', 'timed_out'=>'Timed out' ]
		],
		'SPORTS' =>
		[
		    'SPORTS_TYPE' =>[ 'player'=>'PLAYER','team'=>'TEAM','both'=>'BOTH' ]
		]
    ],
    'SPORT' => [
        1 => 'CricketStatistic',
