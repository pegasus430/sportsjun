...
--> 
    @if(Auth::check() && Auth::user()->type!='1')   <li><a href="{{ url('/myschedule',[(isset(Auth::user()->id)?Auth::user()->id:0)]) }}"><span class="fa"><img src="{{ url('/images/Schedule.png') }}" height="18" width="22"/></span>My Schedule</a></li>
