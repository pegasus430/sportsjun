...
-->    <li><a href="{{ url('/myschedule',[Auth::user()->id]) }}"><span class="fa"><img src="{{ url('/images/Schedule.png') }}" height="18" width="22"/></span>My Schedule</a></li>
			...
			{!! Form::open(['url' => 'search','class'=>'form-horizontal','method' => 'GET','id' => 'search-form']) !!}
               ...
               <!-- <div class="form-group input-addon col-sm-2">
				...
				<div class="form-group input-addon">
                    ...
                    <input type="text" class="form-control input-sm" name="search_city" id="search_city" placeholder="By city" value="<?php if(isset($request_params->search_city)){ echo $request_params->search_city; }else{echo Auth::user()->city;}?>" autocomplete="off">
				               
                </div>
	          <input type="hidden" id="search_city_id" value="<?php if(isset($request_params->search_city_id)){ echo $request_params->search_city_id; }else{echo Auth::user()->city_id;}?>" name="search_city_id" />
				<!-- form group [Name] -->
              	<!-- form group [Address] -->
               <div class="form-group input-addon">
			...
			{!! Form::open(['url' => 'search','class'=>'form-horizontal','method' => 'GET','id' => 'search-form']) !!}
               ...
               <!-- <div class="form-group input-addon col-sm-2">
				...
				<div class="form-group input-addon">
				   ...
				   <input type="hidden" id="search_city_id" value="<?php echo  Auth::user()->city_id;?>" name="search_city_id" />
				 <div class="form-group input-addon">
                    <label class="sr-only" for="filter-location">By name </label>
                    <i class="glyphicon glyphicon-th-list"></i>
                    <input type="text" class="form-control input-sm" name="search_by" id="search_by" placeholder="By name" value="<?php if(isset($request_params->search_by)  && trim($request_params->search_by) != ''){ echo $request_params->search_by; }?>">
