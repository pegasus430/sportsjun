<div class = "row">
    ...
    <div class = "col-sm-6">
        <div class = "section">
            <label class = "form_label">{{   trans('message.team.fields.name') }}<span class = 'required'>*</span>
            </label>
    ...
    <div class = "col-sm-6">
        <div class = "section">
            <label class = "form_label">{{   trans('message.team.fields.sports') }}<span class = 'required'>*</span>
            </label>
...
<!--<div class="tagline"><span>  {{ trans('message.team.fields.gender') }}</span></div>--><!-- .tagline -->
    ...
    <div class = "col-sm-6">
        <div class = "section">
            <label class = "form_label">{{ trans('message.team.fields.gender') }}
        ...
        <div class = "section">
            <div class = "option-group field">
                <label class = "option block">
                    ...
                    @if ($errors->has('player_available'))
                        <p class = "help-block">{{ $errors->first('player_available') }}</p> @endif
                </label>
            </div>
        </div>
    </div>
        ...
        <div class = "section">
            <div class = "option-group field">
                <label class = "option block">
                    ...
                    @if ($errors->has('team_available'))
                        <p class = "help-block">{{ $errors->first('team_available') }}</p> @endif
                </label>
            </div>
        </div>
    </div>
