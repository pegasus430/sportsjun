    ...
    <div class="modal-dialog sj_modal">
        ...
        <div class="modal-content sportsjun-forms">
            ...
            <div class="modal-body">
                <div class="sportsjun-forms sportsjun-container sportsjun-forms-modal">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="section">
                                    ...
                                    <label for="myteam" class="field prepend-icon">
                                        {!! Form::select('my_team_id',$final_stage_teams,null,['class'=>'gui-input','id'=>'my_team_id','placeholder'=> trans('message.schedule.fields.myteam')]) !!}
                                        <div id="container_my_team"></div>
                                        {!! Form::hidden('sports_id', (!empty($sports_id)?$sports_id:'') , array('id' => 'sports_id')) !!}
                                        @if ($errors->has('myteam')) <p
                                                class="help-block">{{ $errors->first('myteam') }}</p> @endif
                            ...
                            <div class="col-sm-6">
                                <div class="section" id="oppTeamDiv">
                                    <label class="form_label">{{   trans('message.schedule.fields.opponentteam') }}<span
                                                class='required'>*</span> </label>
                                    <label for="oppteam" class="field prepend-icon">
                                        {!! Form::select('opp_team_id',$final_stage_teams,null,['class'=>'gui-input','id' => 'opp_team_id','placeholder'=>trans('message.schedule.fields.opponentteam')]) !!}
                                        @if ($errors->has('oppteam')) <p
                                                class="help-block">{{ $errors->first('oppteam') }}</p> @endif
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="section" id="matchStartDatediv">
                                    <label class="form_label">{{   trans('message.schedule.fields.start_date') }}<span
                                                class='required'>*</span> </label>
									...
									<span class="glyphicon glyphicon-calendar"></span>
                                            ...
                                            @if ($errors->has('match_start_date')) <p
                                                    class="help-block">{{ $errors->first('match_start_date') }}</p> @endif
                                        </div>
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="section" id="matchStartTimeDiv">
									...
									<span class="glyphicon glyphicon-calendar"></span>
                                            ...
                                            @if ($errors->has('match_start_time')) <p
                                                    class="help-block">{{ $errors->first('match_start_time') }}</p> @endif
                                        </div>
                                    </label>
                                </div>
                            </div>
                    ...
                    <!-- <div class="section">
                            ...
                            <div class="col-sm-6">
                                <div class="section">
                                    ...
                                    <label class="field select">
                                        ...
                                        @if ($errors->has('player_type')) <p
                                                class="help-block">{{ $errors->first('player_type') }}</p> @endif
                                        <i class="arrow double"></i>
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="section">
                                    ...
                                    <label class="field select">
                                        ...
                                        @if ($errors->has('match_type')) <p
                                                class="help-block">{{ $errors->first('match_type') }}</p> @endif
                                        <i class="arrow double"></i>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="section">
                            <label class="form_label">{{   trans('message.schedule.fields.venue') }}<span
                                        class='required'>*</span> </label>
            ...
            <div class="modal-footer">
                <button type="button" name="save_schedule" id="save_schedule" class="button btn-primary">Schedule
                </button>
    ...
    $(document).ready(function () {
        ...
        $("#schedule_match_btn").click(
                function () {
                    ...
                    $("#myteam").val('');
                    $("#my_team_id").val('').select2({width: "100%"}).trigger('change');
                    $("#oppteam").val('');
                    $("#opp_team_id").val('').select2({width: "100%"}).trigger('change');
                    $("#start_time").val('');
                    $("#end_time").val('');
                    $("#venue").val('');
                    $("#address").val('');
    ...
    function editschedulegroupmatches(schedule_id, is_owner, disableflag) {
        ...
        $.get(base_url + '/editteamschedule', {
            ...
            if (status == 'success') {
                ...
                $(".modal-body #my_team_id").val(parsed_data.scheduleData.a_id).select2({width: "100%"}).trigger("change");
                $(".modal-body #sports_id").val(parsed_data.scheduleData.sports_id);
                $(".modal-body #oppteam").val(parsed_data.team_b_name);
                $(".modal-body #opp_team_id").val(parsed_data.scheduleData.b_id).select2({width: "100%"}).trigger("change");
