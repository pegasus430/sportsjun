...
<div style="width:100%; min-width:480px;"><div style="background:#ececec; padding:50px 0;"><div style="width:80%; height:70px; background:#65c178; margin:auto;">
               ...
               <table cellspacing="0" cellpadding="0" border="0" width="100%" height="70">
                   <tbody><tr>
                     <td align="left" valign="middle"><!-- <h1 style="font-family:Arial, Helvetica, sans-serif; font-size:24px; font-weight:bold; margin:0 0 0 20px; color:#fff;">Email Text</h1> --></td>
                       <td align="right"><img width="254" height="60" style="margin:0 20px 0 0;" onerror="{{ url() }}/images/SportsJun_Logo.png" src="{{ url() }}/images/SportsJun_Logo.png"></td>
                   </tr>
               </tbody></table>
...
To reset the password,click on the link below (or copy paste the URL into your browser):<br>
{{ url('password/reset/'.$token) }}
            <div style="padding:10px 0; font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:normal; line-height:30px;">
                        Regards,<br>
