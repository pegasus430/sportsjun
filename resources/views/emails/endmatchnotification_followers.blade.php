...
<br>
The {{$view_data['sports_name']}} match played on {{date('jS F , Y',strtotime($view_data['match_date']))}} between <b>{{$view_data['team_a_name']}}</b> vs <b>{{$view_data['team_b_name']}}</b> score has been updated and is available to view<br>
