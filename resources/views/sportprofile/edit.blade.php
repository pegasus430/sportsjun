        ...
        <div class="panel panel-default sportsprofile-tabs">
          <div class="panel-body" style="position: relative;">
            ...
            @if($userId==Auth::user()->id)    
                <span class="btn-tooltip" data-toggle="tooltip" data-placement="top" title="Remove {{$userSport->sports_name}}" onclick="removeUserStats('false',{{$userSport->id}},{{ Auth::user()->id }},'follow');"><i class="fa fa-remove"></i></span>
            @endif    
            </li>
            <?php $i++;?>
            @endforeach
            
            @if(count($sports) && $userId==Auth::user()->id)
