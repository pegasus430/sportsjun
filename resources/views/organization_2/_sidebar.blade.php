                ...
                <div class="col-md-12">                       
                    ...
                    <div class="col-md-12">
                        <div class="wg wg-dk-grey no-shadow no-margin">
                            <div class="wg-wrap">
                                <h5 class="no-margin pull-left">Top Headlines</h5>
                                <a href="/organization/{{$organisation->id}}/news"  class="wg-viewmore pull-right">View More<i class="fa fa-angle-double-right"></i></a> 
