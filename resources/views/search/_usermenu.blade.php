...
<form action="{{ url('/search') }}">
	<div class="mp_left sportsjun-forms">		
		...
		@if(count($result) > 0)
		 ...
		 <?php
			$display_status = '';
			if($request_params['sport'] == '')
			  $display_status = 'none';
		 ?>
		  
			<span id="displa_div" style="display: <?php echo  $display_status;?>">
			  <?php /* <h6>Availability to play</h6>
			  <div class="checklist filters">
				<ul>
				   <li> <input class="checkbox2 avialable_check" name="avialable_arr[]" type="checkbox" value='1' autocomplete="off">&nbsp;<span></span>Available</li>
				   
					<li> <input class="checkbox2 avialable_check" name="avialable_arr[]" type="checkbox" value='0' autocomplete="off">&nbsp;<span></span>Not available</li>	
				</ul>
			  </div> */
			  ?>
