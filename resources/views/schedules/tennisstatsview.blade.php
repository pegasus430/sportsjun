    ...
    <div id="teamStatsDiv">
        ...
        <tbody>
            ...
            <tr>
            <td>{{ config('constants.ENUM.SCHEDULE.MATCH_TYPE.TENNIS.singles') }}</td>
            ...
            <tr>
            <td>{{ config('constants.ENUM.SCHEDULE.MATCH_TYPE.TENNIS.doubles') }}</td>
            ...
            <tr>
            <td>{{ config('constants.ENUM.SCHEDULE.MATCH_TYPE.TENNIS.mixed') }}</td>
