<div id="event_points_{{$lis->id}}" class="modal fade">
		<div class="modal-dialog sj_modal sportsjun-forms">
			...
			@endforeach
				...
				<a href="/download/event_points?tournament_id={{$lis->id}}&organization_id={{$orgInfoObj->id}}" class="btn-danger btn" name="match_schedule_tournament_201"><i class="fa fa-download"></i> Download Stading </a>
