                ...
                <tbody>
                        <tr>
                                <td class="sj-social-td">
                                        <button onclick="shareTeamVSOnFacebook();" class="sj-social-ancr sj-social-ancr-fb ladda-button" data-style="slide-left" rel="noreferrer" style="margin: 0; padding: 2px;">
                                          <span>
                                ...
                                <td class="sj-social-td">
                                        <button onclick="shareTeamVSOnTweeter();" class="sj-social-ancr sj-social-ancr-twt ladda-button" data-style="slide-left" rel="noreferrer" style="margin: 0; padding: 2px;">
                                          <span>
