        ...
        <tbody>
          ...
          @for($set_index=1; $set_index<=$set; $set_index++)
            <td>
                ...
                {{$throwball_a_score['set'.$set_index]}}
            </td>
          @endfor
        </tr>
          ...
          <tr>
            ...
            @for($set_index=1; $set_index<=$set; $set_index++)
              <td>
                 ...
                 {{$throwball_b_score['set'.$set_index]}}
...
function scoreCardStatus(status)
{
    ...
    confirm: function() {
        ...
        $.ajax({
            ...
            type: "post",
            data: {'scorecard_status': status,'match_id':match_id,'rej_note':rej_note,'sport_name':'throwball'},
...
function getMatchDetails(){
  ...
  var base_url=base_url || secure_url;
        $.ajax({
            url:  base_url+'/viewpublic/match/getthrowballDetails', 
            type:'get', 
            dataType:'json',
            data:data,
