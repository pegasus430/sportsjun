                ...
                <div class="row">
                      ...
                      <div class="col-md-4 col-sm-12">
						...
						@if($user_b_logo['url']!='')
						  ...
						  {!! Helper::Images($user_b_logo['url'],$upload_folder,array('class'=>'img-responsive img-circle','height'=>204,'width'=>270) )!!}	
  							@else
  						<!--	<img  class="img-responsive img-circle" width="270" height="204" src="{{ asset('/images/default-profile-pic.jpg') }}">-->
					 {!! Helper::Images('default-profile-pic.jpg','images',array('class'=>'img-responsive img-circle','height'=>204,'width'=>270) )!!}	
  						@endif
                        	</div>
      ...
      <thead class="thead">
  		...
  		<tbody>
  			<tr id="set_a">
  				<td>
            @if($user_a_logo['url']!='')
             <!-- <img class="fa fa-user fa-2x" height="42" width="42" src="{{ url('/uploads/'.$upload_folder.'/'.$user_a_logo['url']) }}" onerror="this.onerror=null;this.src='{{ asset('/images/default-profile-pic.jpg') }}';">-->
		   {!! Helper::Images($user_a_logo['url'],$upload_folder,array('class'=>'fa fa-user fa-2x','height'=>36,'width'=>36) )!!}	
              @else
             <!-- <img  class="fa fa-user fa-2x" height="42" width="42" src="{{ asset('/images/default-profile-pic.jpg') }}">-->
		 	   {!! Helper::Images('default-profile-pic.jpg','images',array('class'=>'fa fa-user fa-2x','height'=>36,'width'=>36) )!!}	
            @endif
              {{ $user_a_name }}
  				</td>
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set1']!='' || $score_b_array[0]['set1']!=''))
					<td><span class="score_data_bold">{{(!(empty($score_a_array[0]['set1'])))?$score_a_array[0]['set1']:''}}</span>
					@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set1_tie_breaker']!='' || $score_b_array[0]['set1_tie_breaker']!=''))
						<sup>{{(!(empty($score_a_array[0]['set1_tie_breaker'])))?$score_a_array[0]['set1_tie_breaker']:''}}</sup>
					@endif
				...
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set2']!='' || $score_b_array[0]['set2']!=''))
					<td><span class="score_data_bold">{{(!(empty($score_a_array[0]['set2'])))?$score_a_array[0]['set2']:''}}</span>
					
					@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set2_tie_breaker']!='' || $score_b_array[0]['set2_tie_breaker']!=''))
					<sup>{{(!(empty($score_a_array[0]['set2_tie_breaker'])))?$score_a_array[0]['set2_tie_breaker']:''}}</sup>
					@endif
				...
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set3']!='' || $score_b_array[0]['set3']!=''))
  				<td><span class="score_data_bold">{{(!(empty($score_a_array[0]['set3'])))?$score_a_array[0]['set3']:''}}</span>
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set3_tie_breaker']!='' || $score_b_array[0]['set3_tie_breaker']!=''))
  				<sup>{{(!(empty($score_a_array[0]['set3_tie_breaker'])))?$score_a_array[0]['set3_tie_breaker']:''}}</sup>
				@endif
				</td>
				@endif
				...
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set4']!='' || $score_b_array[0]['set4']!=''))
  				<td><span class="score_data_bold">{{(!(empty($score_a_array[0]['set4'])))?$score_a_array[0]['set4']:''}}</span>
			@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set4_tie_breaker']!='' || $score_b_array[0]['set4_tie_breaker']!=''))
  				<sup>{{(!(empty($score_a_array[0]['set4_tie_breaker'])))?$score_a_array[0]['set4_tie_breaker']:''}}</sup>
				@endif
			</td>
				@endif
				...
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set5']!='' || $score_b_array[0]['set5']!=''))
  				<td><span class="score_data_bold">{{(!(empty($score_a_array[0]['set5'])))?$score_a_array[0]['set5']:''}}</span>
			@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set5_tie_breaker']!='' || $score_b_array[0]['set5_tie_breaker']!=''))
  				<sup>{{(!(empty($score_a_array[0]['set5_tie_breaker'])))?$score_a_array[0]['set5_tie_breaker']:''}}</sup>
				@endif
			</td>
				@endif
				
				
  				<td><span class="score_data_bold">{{(!(empty($score_a_array[0]['aces'])))?$score_a_array[0]['aces']:''}}</span></td>
  				<td><span class="score_data_bold">{{(!(empty($score_a_array[0]['double_faults'])))?$score_a_array[0]['double_faults']:''}}</span></td>
  			...
  			<tr id="set_b">
  				<td>
  						@if($user_b_logo['url']!='')
  							<!--<img class="fa fa-user fa-2x" height="42" width="42" src="{{ url('/uploads/'.$upload_folder.'/'.$user_b_logo['url']) }}" onerror="this.onerror=null;this.src='{{ asset('/images/default-profile-pic.jpg') }}';">-->
              ...
              {{ $user_b_name }}
					...
					@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set1']!='' || $score_b_array[0]['set1']!=''))
  					<td><span class="score_data_bold">{{(!(empty($score_b_array[0]['set1'])))?$score_b_array[0]['set1']:''}}</span>
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set1_tie_breaker']!='' || $score_b_array[0]['set1_tie_breaker']!=''))
  					<sup>{{(!(empty($score_b_array[0]['set1_tie_breaker'])))?$score_b_array[0]['set1_tie_breaker']:''}}</sup>
					@endif
				</td>
					@endif
					...
					@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set2']!='' || $score_b_array[0]['set2']!=''))
  					<td><span class="score_data_bold">{{(!(empty($score_b_array[0]['set2'])))?$score_b_array[0]['set2']:''}}</span>
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set2_tie_breaker']!='' || $score_b_array[0]['set2_tie_breaker']!=''))
  					<sup>{{(!(empty($score_b_array[0]['set2_tie_breaker'])))?$score_b_array[0]['set2_tie_breaker']:''}}</sup>
					@endif
				</td>
					@endif
					...
					@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set3']!='' || $score_b_array[0]['set3']!=''))
  					<td><span class="score_data_bold">{{(!(empty($score_b_array[0]['set3'])))?$score_b_array[0]['set3']:''}}</span>
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set3_tie_breaker']!='' || $score_b_array[0]['set3_tie_breaker']!=''))
  					<sup>{{(!(empty($score_b_array[0]['set3_tie_breaker'])))?$score_b_array[0]['set3_tie_breaker']:''}}</sup>
					@endif
				</td>
					@endif
					...
					@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set4']!='' || $score_b_array[0]['set4']!=''))
  					<td><span class="score_data_bold">{{(!(empty($score_b_array[0]['set4'])))?$score_b_array[0]['set4']:''}}</span>
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set4_tie_breaker']!='' || $score_b_array[0]['set4_tie_breaker']!=''))
  					<sup>{{(!(empty($score_b_array[0]['set4_tie_breaker'])))?$score_b_array[0]['set4_tie_breaker']:''}}</sup>
					@endif
				</td>
					@endif
					...
					@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set5']!='' || $score_b_array[0]['set5']!=''))
  					<td><span class="score_data_bold">{{(!(empty($score_b_array[0]['set5'])))?$score_b_array[0]['set5']:''}}</span>
				@if((!empty($score_a_array[0]) || !empty($score_b_array[0])) && ($score_a_array[0]['set5_tie_breaker']!='' || $score_b_array[0]['set5_tie_breaker']!=''))
  					<sup>{{(!(empty($score_b_array[0]['set5_tie_breaker'])))?$score_b_array[0]['set5_tie_breaker']:''}}</sup>
					@endif
				</td>
					@endif
					
					<td><span class="score_data_bold">{{(!(empty($score_b_array[0]['aces'])))?$score_b_array[0]['aces']:''}}</span></td>
					<td><span class="score_data_bold">{{(!(empty($score_b_array[0]['double_faults'])))?$score_b_array[0]['double_faults']:''}}</span></td>
  			</tr>
  		</tbody>
  	</table>
  </div>
...
<!-- End Rubber -->
    ...
    <div class="sportsjun-forms text-center scorecards-buttons">
        ...
        @if($isValidUser && $isApproveRejectExist)		
            ...
            <textarea name="rej_note" id="rej_note" rows="4" cols="50" placeholder="Reject Note" style="margin:20px 0 10px 0; width: 100%;"></textarea>
        @endif
    </div>
