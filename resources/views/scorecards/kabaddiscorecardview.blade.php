...
function scoreCardStatus(status)
{
    ...
    confirm: function() {
        ...
        $.ajax({
            ...
            type: "post",
            data: {'scorecard_status': status,'match_id':match_id,'rej_note':rej_note,'sport_name':'kabaddi'},
...
function getMatchDetails(){
  ...
  var base_url=base_url || secure_url;
        $.ajax({
            url:  base_url+'/viewpublic/match/getkabaddiDetails', 
            type:'get', 
            dataType:'json',
            data:data,
