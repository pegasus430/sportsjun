...
$disabled = "readonly";
//$required = '';
$route = array('user.update',Auth::user()->id);
       ...
       <div class="form-header header-primary"><h4><i class="fa fa-pencil-square"></i>{{ trans('message.users.fields.editheading') }}</h4></div><!-- end .form-header section -->  
		...
		@endif	   
		 {!! Form::model($userDetails,(array('route' => $route,'class'=>'form-horizontal','method' => 'put', 'files' => true,'id'=>'edit-form'))) !!}
                ...
                {!! Form::hidden('profile_updated', null , array('id' => 'profile_updated')) !!} 
		 ...
		 <div class="row">
             ...
             <label class="form_label">{{  trans('message.users.fields.firstname') }} <span  class='required'>*</span></label>
                <label for="firstname" class="field prepend-icon">
                    {!! Form::text('firstname', null, array('required', 'class'=>'gui-input','placeholder'=>trans('message.users.fields.firstname'))) !!}
            ...
            <div class="section">
              <label class="form_label">{{  trans('message.users.fields.lastname') }} <span  class='required'>*</span></label>
                <label for="lastname" class="field prepend-icon">
                    {!! Form::text('lastname', null, array('required', 'class'=>'gui-input','placeholder'=>trans('message.users.fields.lastname'))) !!}
		...
		<div class="section">
    	  <label class="form_label">{{  trans('message.users.fields.email') }} <span  class='required'>*</span></label>
			<label for="useremail" class="field prepend-icon">
				 {!! Form::email('email', null, array('class'=>'gui-input',$disabled,'email'=>'unique:users,email,'.$edit_user_id,'placeholder'=>trans('message.users.fields.email'))) !!}
		...
		<div class="section">
    	  <label class="form_label">{{  trans('message.users.fields.dob') }} </label>
			...
			<div class='input-group date' id='dob_date_format'>
        ...
        <div class="col-sm-12">
					...
					@if(isset($userDetails))
                      @include('common.editphoto',['photos'=>$userDetails->photos,'type'=>'user_profile'])
                   @endif
		<div class="section">
