...
class MarketplaceCategoriesController extends Controller
{
	...
	{
		 return view('admin.marketplace.createcategory');
	}
   public function viewMarcketPlaceCategories()
   {
		...
		$grid->link('admin/createcategory',"Add New", "TR"); 
   ...
   public function deletecategory()
   {
		...
		if(isset($delete_category_id) && $delete_category_id>0)
		{
			...
			return redirect()->route('admin/viewcategories')->with('status', trans('message.marketplacecategory.delete'));
		...
		return view('admin.marketplace.createcategory',array('category_array' => $category_array));
   }
   public function insertcategory()
   {
			...
			$categories->save();
			return redirect()->route('admin/viewcategories')->with('status', trans('message.marketplacecategory.create'));
   }
   public function updatecategory()
   {
	   $request = Request::all();
		...
		return redirect()->route('admin/viewcategories')->with('status', trans('message.marketplacecategory.update'));
   }
}
