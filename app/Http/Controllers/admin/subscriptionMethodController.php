...
class subscriptionMethodController extends Controller
{
    ...
    {
        //
        $s_methods = sm::orderBy('type')->get();
        $types = config('constants.ENUM.SUBSCRIPTION_TYPE');

        return view('admin.settings.subscription_methods', compact('subscriptions', 's_methods','types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $sm->details = $request->details;
        $sm->duration = $request->duration;
        $sm->save();
