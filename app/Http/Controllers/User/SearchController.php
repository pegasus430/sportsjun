...
class SearchController extends Controller
{
    ...
    public function searchResultsByTypeAutoComplete(Request $request){
		...
		$models = array('App\\User','App\\Model\\Facilityprofile','App\\Model\\Tournaments','App\\Model\\Team');
        $result = array();
    ...
    {	
		...
		//dd($sports_array);
		if($request->ajax()){
			return view('search.'.$modelType.'ajax')->with(array('result'=>$result,'exist_array'=>$exist_items_array,'follow_array'=>$follow_items_array,'sports_array'=>$sports_array,'request_params'=>$request,'max'=>$max,'min'=>$min,'states' => ['' => 'Select State'] + $states,'cities' => ['' => 'Select City'] + $cities,'page'=>'marketplace','categories_array' => $categories_array,'marketPlaceCategories' => $marketPlaceCategories,'offset'=> $offset + $limit,'limit'=> $limit,'totalcount'=>$totalcount,'name'=>$name,'city'=>$city,'category'=>$category,'modeltype'=> $modelType,'sport_by'=>$sport_by,'search_city'=>$search_city,'city_by'=>$city_by,'category_by'=>$category_by,'search_by_name'=>	$search_by_name,"view_more_flag"=>$view_more_flag));  
		}
		else{
			return view('search.'.$modelType)->with(array('result'=>$result,'exist_array'=>$exist_items_array,'follow_array'=>$follow_items_array,'sports_array'=>$sports_array,'request_params'=>$request,'max'=>$max,'min'=>$min,'states' => ['' => 'Select State'] + $states,'cities' => ['' => 'Select City'] + $cities,'page'=>'marketplace','categories_array' => $categories_array,'marketPlaceCategories' => $marketPlaceCategories,'offset'=> $offset + $limit,'limit'=> $limit,'totalcount'=>$totalcount,'name'=>$name,'city'=>$city,'category'=>$category,'modeltype'=> $modelType,'sport_by'=>$sport_by,'search_city'=>$search_city,'city_by'=>$city_by,'category_by'=>$category_by,'search_by_name'=>	$search_by_name,"view_more_flag"=>$view_more_flag));  
		}
	...
	public function viewmore(Request $request)
		...
		if($request->ajax()){
			return view('search.'.$modelType.'ajax')->with(array('result'=>$result,'exist_array'=>$exist_items_array,'follow_array'=>$follow_items_array,'sports_array'=>$sports_array,'request_params'=>$request,'max'=>$max,'min'=>$min,'states' => ['' => 'Select State'] + $states,'cities' => ['' => 'Select City'] + $cities,'page'=>'marketplace','categories_array' => $categories_array,'marketPlaceCategories' => $marketPlaceCategories,'offset'=> $offset + $limit,'limit'=> $limit,'totalcount'=>$totalcount,'sport_by'=>$sport_by,'search_city'=>$search_city,'city_by'=>$city_by,'category_by'=>$category_by,'search_by_name'=>	$search_by_name,"view_more_flag"=>$view_more_flag));  
		}
		else{
			return view('search.'.$modelType)->with(array('result'=>$result,'exist_array'=>$exist_items_array,'follow_array'=>$follow_items_array,'sports_array'=>$sports_array,'request_params'=>$request,'max'=>$max,'min'=>$min,'states' => ['' => 'Select State'] + $states,'cities' => ['' => 'Select City'] + $cities,'page'=>'marketplace','categories_array' => $categories_array,'marketPlaceCategories' => $marketPlaceCategories,'offset'=> $offset + $limit,'limit'=> $limit,'totalcount'=>$totalcount,'sport_by'=>$sport_by,'search_city'=>$search_city,'city_by'=>$city_by,'category_by'=>$category_by,'search_by_name'=>	$search_by_name,"view_more_flag"=>$view_more_flag));  
		}
	...
	public function suggestedWidget(Request $request)
    {
    	...
    	return view('widgets/suggested'.$modelType)->with(array('result'=>$result,'sports_array'=>$sports_array,'request_params'=>$request,'controller_name'=>$controller_name,'sport_id'=>$sport_id,'city'=>$city,'city_id'=>$city_id));
	}
