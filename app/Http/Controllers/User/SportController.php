...
//    }
    ...
    public function getplayerrequests($id)
    {
        ...
        return view('sportprofile.playerrequests',['result'=>$result,'sent'=>$sent,'received_count'=>$result_count,'sent_count'=>$sent_count,'limit'=>$limit,'offset1'=>$limit+$offset,'offset2'=>$limit+$offset,'userId'=>Auth::user()->id]);
    }  
    //function to show the requests
