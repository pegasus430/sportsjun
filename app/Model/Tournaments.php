...
class Tournaments extends Model {
    ...
    protected $fillable = array('id', 'name', 'created_by', 'sports_id', 'start_date', 'end_date', 'contact_number', 'email', 'location', 'longitude', 'latitude', 'address',
        'city_id', 'city', 'state_id', 'state', 'country_id', 'country', 'zip', 'groups_number', 'groups_teams', 'facility_id', 'prize_money', 'enrollment_fee', 'points_win', 'points_loose',
        'status', 'description', 'final_stage_teams', 'type', 'facility_name', 'schedule_type', 'alternate_contact_number', 'contact_name','logo','tournament_parent_id','tournament_parent_name','manager_id','match_type','player_type');
